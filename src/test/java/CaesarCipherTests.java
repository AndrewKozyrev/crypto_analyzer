...
public class CaesarCipherTests {
    ...
    public static Stream<Arguments> providerHackCipher() {
        return Stream.of(
                ...
                Arguments.of("дз-!,.из!жвё,?лкш.з!ж,.ифевжд,ъ.:.ж?г.кз!?йавлкш.:кш.б?ёешъ.дз-!,.й,кимкд,?лкш.з!вж.п:?лздъ.й,кдйф:,?лкш.п?ефг.ёвй", "когда поднимается одна пылинка, в ней содержится вся земля, когда распускается один цветок, раскрывается целый мир")
        );
    }
